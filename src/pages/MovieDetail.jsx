...
export default function MovieDetail() {
    ...
    console.log(poster_path.id);
     useEffect(() => {
       axiosInstance.get(`https://api.themoviedb.org/3/movie/${poster_path.id}?api_key=7f74ffb2996003663e3879edf6de0988`)
  ...
  return (
    <Col className="selectedMcard">
      ...
      <div className="selcard-body">
        ...
        <p className="selcard-text">{movies.vote_average}</p>
        <p className="selcard-text"><strong>Release Date:</strong> {movies.release_date}</p>
      </div>
    </Col>
  );
